...
def predict(log_path, order):
   ...
   # pay_rej_path = '/Users/wenchao/Developer/OnlinePredict/parsing/db_pay_rej.txt'
    ...
    db_path = '../RatePrediction/data/research_refuse.gorders'
    pay_rej_path = '../OnlinePredict/parsing/db_pay_rej.txt'
    ...
    parsing_result_path = '../OnlinePredict/parsing/test_log.txt'
    ...
    # Debug:
    final_feature = get_db_list('../RatePrediction/final_feature_with_cancel.txt')
    #print final_feature
    train = []
    train_label = []
    test = []
