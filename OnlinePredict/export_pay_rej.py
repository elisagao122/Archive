...
if __name__ == '__main__':
    ...
    db_path = 'E:/BaiduYunDownload/Archive/RatePrediction/data/research_refuse.gorders'
    pay_rej_path = 'E:/BaiduYunDownload/Archive/RatePrediction/parsing/db_pay_rej.txt'
